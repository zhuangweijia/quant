...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('symbol', 'market', 'timeframe', 'timestamp', name='uq_market_data_symbol_tf_ts')
    )
    ...
    op.create_index('ix_orders_strategy_created', 'orders', ['strategy_id', 'created_at'], unique=False)
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'strategy_id', 'symbol', name='uq_position_user_strategy_symbol')
    )
